...
<p align="center">
<img src="https://github.com/vpalombo/PANEV/tree/master/vignettes/images/fig1.jpg" width="350" title="The general architecture of the workflow of PANEV package and schematic illustration of main functions. The yellow rectangles represent the PANEV functions. The green circles represent the input data lists, in particular gene or pathway lists. The red diamonds represent the output from data preparation PANEV functions. The blue rectangles represent the final PANEV outcomes."> <img src="https://github.com/vpalombo/PANEV/tree/master/vignettes/images/fig1.jpg" width="350" alt="The general architecture of the workflow of PANEV package and schematic illustration of main functions. The yellow rectangles represent the PANEV functions. The green circles represent the input data lists, in particular gene or pathway lists. The red diamonds represent the output from data preparation PANEV functions. The blue rectangles represent the final PANEV outcomes.">
</p>
Example files
=============
