...
#Installation
This manual focuses on PaNeV v.1.0. PaNeV requires the pre-installation of the following packages: ‘devtools’ (https://cran.r-project.org/package=devtools), ‘biomaRt’ and ‘KEGGREST’ (https://bioconductor.org/). 
