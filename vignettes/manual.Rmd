...
#Installation
This manual focuses on PaNeV v.1.0. PaNeV requires the pre-installation of ‘devtools’ package from CRAN (https://cran.r-project.org/package=devtools). Once satisfied the requirement, the R scripts and package described in this manual can be downloaded and installed from github link https://github.com/vpalombo/panev. 
